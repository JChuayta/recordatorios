...
class _MiHomeState extends State<MiHome> {
  ...
  FabricaWidgets fabrica = new MaterialWidget();//INSTANCIA DEL PATRON FABRICA ABSTRACTA
  Recordatorio _recordatorio;  // INSANCIA DEL PATRON FABRICA ABSTRACTA Y PROTOTIPE
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                child: CardLista(Colors.blue,index,this._recordatorio),
              );
            },
          ),
        ),
            ...
            showDialog(
              ...
              builder: (BuildContext context) {
                return AlertDialog(
                  ...
                  content: const Text(
                      "Desea Clonar la nota con los mismos datos?"),
                  actions: <Widget>[
                    FlatButton(
                        onPressed: () {
                          setState(() {
  ...
  Widget colores() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          colorsitos(Colors.red,"Rojo"),
          colorsitos(Colors.blue,"Azul"),
          colorsitos(Colors.yellow,"Amarillo"),
          colorsitos(Colors.green,"Verde"),
          colorsitos(Colors.pink,"Rosa"),
        ],
      ),
    );
  }
  ...
  Widget colorsitos(Color color, String text) {
    return GestureDetector(
      onTap: () {crearColor(text);},
      child: Container(
        height: 30.0,
        width: 30.0,
        decoration: BoxDecoration(
